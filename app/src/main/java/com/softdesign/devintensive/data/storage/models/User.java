...
public class User {
    ...
    public User(UserListRes.UserData userData) {
        remoteId = userData.getId();
        photo = userData.getPublicInfo().getPhoto();
        fullName = userData.getFullName();
        searchName = userData.getFullName().toUpperCase();
        rating = userData.getProfileValues().getRaiting();
        codeLines = userData.getProfileValues().getLinesCode();
        projects = userData.getProfileValues().getProjects();
        bio = userData.getPublicInfo().getBio();
    }
